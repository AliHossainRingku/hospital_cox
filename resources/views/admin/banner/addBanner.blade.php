...
@section('admin_content')
    ...
    <form class="form-horizontal" action="{{URL::to('admin/banners')}}" method="post">
        {{csrf_field()}}
        <div class="form-group">
            <label class="control-label col-sm-2" for="banner_title">Banner Title:</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" id="banner_title" name="banner_title" placeholder="Enter Banner Title" required>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <textarea type="text" class="form-control" id="banner_description" name="banner_description" placeholder="Enter Slider/Banner Description" required></textarea>
            </div>
        </div>
